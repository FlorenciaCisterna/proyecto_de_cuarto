...
void loop() {
  ...
  // Formatear los datos en una sola línea
  String dataToSend = separator+String(flex1) + separator + String(flex2) + separator + String(flex3) +
                     separator + String(flex4) + separator + String(flex5) + separator +
                     String(accel_ang_x) + separator + String(accel_ang_y) + separator +
                     String(pulsador);
